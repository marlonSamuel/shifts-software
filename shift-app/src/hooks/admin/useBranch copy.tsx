...
import { IBranch, IBranchDepartment } from '../../interfaces/IAdmin';
...
export const useBranch = () => {
  ...
  const [departments, setDepartments] = useState<IBranchDepartment[]>([]);
    ...
    //lista inicial de data
    const getAllDepartmentsByBranch = async(branch_id:string) => {
        setLoading(true);
        await api.get('/branches_departments/'+branch_id).then(r=> {
